...
/*------------------------重新定义----------------------*/
Blockly.ALS_SETUP = "初始化";
Blockly.AlsDelayMs='毫秒';
Blockly.AlsDelayUs='微秒';
Blockly.AlsDelay='延时';
Blockly.AlsForward = "向前";
Blockly.AlsBackwards = "向后";
Blockly.AlsLeft = "向左";
Blockly.AlsRight = "向右";
Blockly.AlsSecond = "秒" ;
Blockly.AlsLookLeft = "看左" ;
Blockly.AlsLookRight = "看右" ;
Blockly.AlsLookPeople = "看向说话的人" ;
Blockly.AlsLightLeft = "左灯" ;
Blockly.AlsLightRight = "右灯" ;
Blockly.AlsLightFront = "前灯" ;
Blockly.AlsLightBehind = "后灯" ;
Blockly.AlsLightAll = "所有灯" ;
Blockly.AlsSoundOnly = "说话" ;
Blockly.AlsSoundSay = "说" ;
Blockly.AlsSoundAnimal = "动物" ;
Blockly.AlsSoundStrange = "奇怪" ;
Blockly.AlsSoundVehicle = "交通工具" ;
Blockly.AlsAnimationOnly = "跳舞" ;
Blockly.AlsAnimationGreet= "问候" ;
Blockly.AlsAnimationDance= "跳舞" ;
Blockly.AlsAnimationExpression = "表情" ;
Blockly.AlsAnimationMatch = "比赛" ;
Blockly.AlsAnimationAnswer = "回答" ;
Blockly.AlsAnimationPlay = "播放" ;
Blockly.AlsFunLine = "寻线" ;
Blockly.AlsFunDistance = "探测障碍物距离" ;
Blockly.AlsFunLight = "探测光线强度" ;
Blockly.AlsFunSound = "探测声音强度" ;
Blockly.AlsFunTempHum = "探测温湿度传感器" ;
Blockly.AlsFunTemp = "探测温度值" ;
Blockly.AlsFunCompass = "读取电子罗盘" ;
Blockly.AlsFunPot = "读取电位器的值" ;
Blockly.AlsFunRed = "读取人体红外传感器的状态值" ;


/*--------------------------提示--------------------------*/
Blockly.ALS_SETUP_TIP = '初始化操作(这里面的内容只执行一次)';
Blockly.AlsDelayTip = '延迟指定时间' ;
Blockly.AlsForwardTip = "向前多少秒" ;
Blockly.AlsBackwardsTip = "向后多少秒" ;
Blockly.AlsLeftTip = "向左多少秒" ;
Blockly.AlsRightTip = "向右多少秒" ;
Blockly.AlsLookLeftTip = "看向左边" ;
Blockly.AlsLookRightTip = "看向右边" ;
Blockly.AlsLookPeopleTip = "看向说话的人" ;
Blockly.AlsLightLeftTip = "左灯亮" ;
Blockly.AlsLightRightTip = "右灯亮" ;
Blockly.AlsLightFrontTip = "前灯亮" ;
Blockly.AlsLightBehindTip = "后灯亮" ;
Blockly.AlsLightAllTip = "所有灯亮" ;
Blockly.AlsSoundOnlyTip = "说话" ;
Blockly.AlsSoundSayTip = "说" ;
Blockly.AlsSoundAnimalTip = "模拟动物声音" ;
Blockly.AlsSoundStrangeTip = "发出奇怪的声音" ;
Blockly.AlsSoundVehicleTip = "发出交通工具的声音" ;
Blockly.AlsAnimationOnlyTip = "跳舞" ;
Blockly.AlsAnimationGreetTip = "问候" ;
Blockly.AlsAnimationDanceTip = "跳舞" ;
Blockly.AlsAnimationExpressionTip = "表情" ;
Blockly.AlsAnimationMatchTip = "比赛" ;
Blockly.AlsAnimationAnswerTip = "回答" ;
Blockly.AlsAnimationPlayTip = "播放" ;
Blockly.AlsFunLineTip = "寻线" ;
Blockly.AlsFunDistanceTip = "探测障碍物距离" ;
Blockly.AlsFunLightTip = "探测光线强度" ;
Blockly.AlsFunSoundTip = "探测声音强度" ;
Blockly.AlsFunTempHumTip = "探测温湿度传感器" ;
Blockly.AlsFunTempTip = "探测温度值" ;
Blockly.AlsFunCompassTip = "读取电子罗盘" ;
Blockly.AlsFunPotTip = "读取电位器的值" ;
Blockly.AlsFunRedTip = "读取人体红外传感器的状态值" ;
