...
/*循环*/
Blockly.JavaScript['base_loop'] = function(block) {
    var number_name = block.getFieldValue('NAME');
    var statements = Blockly.JavaScript.statementToCode(block, 'other');
    var code = 'lp ' + number_name + statements + 'elp ';
    return code;
};
...
Blockly.JavaScript['animation_expression'] = function(block) {
    ...
    var code = 'bq ' + dropdown_expression + ' ';
    return code;
};
